      ...
      <section className=' aboutsec w-screen flex justify-center z-0 '>
        <div className=' w-10/12 border-r-2 border-l-2'>
          <div className='flex-col'>
            <div className='flex-col flex gap-4 mb-24'>
            ...
            <div className='flex '>
              ...
              <div className='layoutdiv flex flex-col gap-10 pl-20 w-8/12 pr-20'>
                <div className=' aboutdiv p-8 w-'><h1 className='text-xl font-extrabold mb-4'>Who am I?</h1><p className=' text-gray-700 text-justify '>I am <span className=' font-bold'>Kjell Arved Brandt</span>, born and raised in Berlin/Brandenburg. My sporting career began with swimming at the age of six. After a successful career as a competitive swimmer, in  which I gained a lot of experience and success, I started triathlon in 2023. In my first season, I was already able to achieve impressive successes, including winning the German Triathlon and Duathlon Championships[...] <a href="" className=' cursor-pointer text-blue-500 font-semibold text-sm '>More...</a> </p></div>
                <div className='flex w-full justify-between'>
                  <div className=' achibox p-6'>
                    <h1 className=' text-xl font-extrabold mb-4 self-center'>Achievments <span className=' text-2xl ml-2'>&#127942;</span> </h1>
                    <ul className=' list-none'>
                      <li className='flex-col flex gap-1'>
                  ...
                  <div className='goalbox p-6'>
                    <h1 className=' text-xl font-extrabold mb-4 self-center'>Goals<span className=' text-2xl ml-2'>&#127919;</span></h1>
                    <p><h3 className='font-extrabold mr-2'>2024-2025</h3>Junior world title & top international results. <br /> <h3 className='font-extrabold mr-2'>2026-2027</h3> Elite breakthrough & German champion. <br /><h3 className='font-extrabold mr-2'>2028</h3><span className=' text-xl mr-1'>&#129351;</span> LA Olympics – medal goal.<br /><a href="" className='cursor-pointer text-blue-500 font-semibold text-sm '>More...</a></p>

                  </div>
                </div>
              </div>

              <div className='jemdiv flex w-4/12'>
